...
execute_process(
  COMMAND "C:/Program Files/Git/cmd/git.exe" --git-dir=.git show-ref "v0.9.7"
  WORKING_DIRECTORY "D:/GitHub/NaviGator/build/_deps/magic_enum-src"
...
if(git_update_strategy STREQUAL "CHECKOUT")
  ...
  if(error_code)
    ...
    if(NOT git_update_strategy STREQUAL "REBASE_CHECKOUT")
      ...
      message(FATAL_ERROR "\nFailed to rebase in: 'D:/GitHub/NaviGator/build/_deps/magic_enum-src'."
...
if(need_stash)
  ...
  if(error_code)
    ...
    if(error_code)
      ...
      message(FATAL_ERROR "\nFailed to unstash changes in: 'D:/GitHub/NaviGator/build/_deps/magic_enum-src'."
                          "\nYou will have to resolve the conflicts manually")
    endif()
  endif()
endif()
